...
public class ProductFactoryDefault implements ProductFactory {
    ...
    public Product populateInstance(ResultSet rs) throws SQLException {
        return newInstance(rs.getString("productCode"), rs.getString("productName"), rs.getString("productLine"),
                rs.getString("productScale"), rs.getString("productVendor"), rs.getString("productDescription"),
                rs.getInt("quantityInStock"), rs.getBigDecimal("buyPrice"), rs.getBigDecimal("msrp"));
    }
    ...
    public Product newInstance(String productCode, String productName, String productLine, String productScale,
